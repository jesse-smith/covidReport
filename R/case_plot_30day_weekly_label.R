...
#'
#' @export
case_plot_daily_recent_week <- function(
  ...
  gg_data %>%
    ...
    add_recent_title_week(new= n_new, total_30 = n_total_30, date=date)
}
...
#'
#' @noRd
add_recent_title_week <- function(gg_obj, new, total_30, date) {
