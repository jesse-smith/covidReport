...
grant_death_quarterly_rate <- function(
  ...
  pal_n <- 9L
  pal <- RColorBrewer::brewer.pal(pal_n, "YlOrRd")
...
#
#
# grant_death_quarterly_rate <- grant_death_quarterly_rate()
...
#   ext = "png"
# )
# coviData::save_plot(grant_death_quarterly_rate, path = path_grant_death_quarterly_rate, ratio = c(12,9), size = 1.125)
